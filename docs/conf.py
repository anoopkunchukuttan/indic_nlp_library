...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode', 'sphinx.ext.napolean', 'sphinxarg.ext']
...
texinfo_documents = [
  ('index', 'IndicNLPLibrary', 'Indic NLP Library Documentation',
   'Anoop Kunchukuttan', 'IndicNLPLibrary', 'One line description of project.',
   'Miscellaneous'),
]
